...
The focus is on understanding flow and structure rather than full implementation.
...
The following diagram shows the high-level flow of the AI Tutor POC system.

It represents the current frontend-first approach and planned backend and AI integration.
